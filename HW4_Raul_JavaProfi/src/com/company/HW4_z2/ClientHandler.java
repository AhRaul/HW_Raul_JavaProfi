    ...
    public ClientHandler(Socket socket, Server server) {
        ...
        try {
            ...
            new Thread(() -> {
                ...
                cl.readMessageToFile();             //?? дз 3 профи вывод пользователю 100 сообщений (как лучше вызвать метод чужого класса без создания обьекта этого класса)
                ...
                while (socket.isConnected()) {
                    ...
                    switch (msg.getType()) {
                        ...
                        case PRIVATE_MESSAGE:
                            ...
                            break;
//                        case NEW_NICK_MESSAGE:
//                            setNewNick(msg.getBody());
//                            break;
                        case BROADCAST_CHAT:
...
//    private void setNewNick(String messageWithNickTo) {
//        int twoSpaceIndex = messageWithNickTo.indexOf(" ");
//        final String newNick = messageWithNickTo.substring(1, twoSpaceIndex);
//        server.getAuthService().setNewNick(nick, newNick);
//        this.nick = newNick;
//    }
